...
GO
PRINT N'Altering [dbo].[PARTICIPANTE]...';


GO
ALTER TABLE [dbo].[PARTICIPANTE]
    ADD [DAT_CADASTRO]    DATETIME DEFAULT getdate() NOT NULL,
...
ALTER TABLE [dbo].[USUARIO]
    ADD [DAT_MODIFICACAO] DATETIME DEFAULT getdate() NOT NULL;
...
GO
ALTER TABLE [dbo].[USUARIO]
    ADD DEFAULT getdate() FOR [DAT_CADASTRO];
