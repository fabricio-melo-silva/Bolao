				...
				function (xtr, status, error) {
					if (typeof (xtr.responseJSON.Message) != 'undefined') {
						if (xtr.responseJSON.Message == 'Logoff') {
							...
							alert(xtr.responseJSON.Message);
						}
					}
					else {
					...
					<div class="box-branco clearfix box-miolo">
						...
						<asp:Panel ID="pnLegenda" runat="server" CssClass="clearfix">
							<span class="legenda-label">
								<span class="legenda-indicador"></span>Jogo cujo resultado não foi computado</span>
							<span class="legenda-label">
								<span class="legenda-indicador legenda-indicador-verde"></span>Jogo cujo resultado foi computado</span>
							<span class="legenda-label">
									...
									<asp:Panel ID="pnJogo" runat="server" CssClass="aposta even row">
										...
										<div class="aposta-content">
											...
											<div class="form-aposta">
												<asp:TextBox ID="tbPlacarTimeA" runat="server" CssClass="campo-placar" TextMode="Number" MaxLength="2" /> 
												<span class="span-vs">X</span>
												<asp:TextBox ID="tbPlacarTimeB" runat="server" CssClass="campo-placar" TextMode="Number" MaxLength="2" /> 
											</div>
										...
										<asp:Panel ID="pnPlacarFinal" runat="server" CssClass="placar-final-content">
											<div class="placar-final">
												<div class="tag-placar-final"><asp:Literal ID="ltResultadoTimeA" runat="server"></asp:Literal></div>
												<span>Placar Final</span>
												<div class="tag-placar-final"><asp:Literal ID="ltResultadoTimeB" runat="server"></asp:Literal></div>
											</div>
